...
color_names = ['blue', 'red', 'green', 'orange', 'purple', 'pink', 'white']
...
np.save('/home/huihanl/cliport/data/language_dictionary_val.npy', all_languages)
#np.save('/home/huihanl/cliport/data/action_dictionary_val.npy', all_actions.detach().cpu().numpy())
