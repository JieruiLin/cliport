...
train_dataset = ForwardDatasetClassificationAllObjects(os.path.join(data_dir, f'{cfg["task"]}-train'), cfg, n_demos=500, augment=None)
...
if TRAIN:
    for epoch in tqdm(range(100)):
        ...
        if epoch % 10 == 0:
            torch.save(model, "icm_model_all_classes_with_object_classes.pt")
else:
